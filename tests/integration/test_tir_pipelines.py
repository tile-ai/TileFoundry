...
from tests.fixtures.tir.pipelined_gemm import PipelinedGemm
from tests.fixtures.tir.rmsnorm import TirRmsnorm
from tilefoundry.target import CudaTarget


@pytest.mark.skipif(not torch.cuda.is_available(), reason="requires CUDA")
@pytest.mark.parametrize("fixture", [TirRmsnorm, MmHandwritten, PipelinedGemm], ids=["rmsnorm", "mma", "pipeline"])
