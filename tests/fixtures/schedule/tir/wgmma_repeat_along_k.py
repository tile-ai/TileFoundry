    ...
    with Mesh((Topology("cta", 1),), Layout((1,), (1,)), names=("d0",)) as cta:
        ...
        with Mesh(
            ...
            lhs_stages = (T.tensor_view(2048, dtype='bf16', storage=StorageKind.SMEM, layout=ComposedLayout(
                ...
                ), shape=(128, 64)), T.tensor_view(10240, dtype='bf16', storage=StorageKind.SMEM, layout=ComposedLayout(
                    inner=Swizzle(3, 4, 3),
                    offset=0,
                    outer=Layout(((2, 8, 8), (4, 16)), ((4096, 512, 64), (16, 1))),
                ), shape=(128, 64)))
            rhs_stages = (T.tensor_view(0, dtype='bf16', storage=StorageKind.SMEM, layout=Layout(((4, 2, 8), (2, 8)), ((256, 64, 8), (128, 1))), shape=(64, 16)), T.tensor_view(1024, dtype='bf16', storage=StorageKind.SMEM, layout=Layout(((4, 2, 8), (2, 8)), ((256, 64, 8), (128, 1))), shape=(64, 16)))
            with Mesh(
