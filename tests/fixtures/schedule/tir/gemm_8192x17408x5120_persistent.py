...
def gemm(
    ...
    with Mesh((Topology("cta", 132),), Layout((132,), (1,)), names=("d0",)) as cta:
        ...
        with Mesh(
            ...
            for t in range(cta.d0, 4352, 132):
    ...
    outer=Layout((2, 4, 8, 4), (128, 32, 4, 1)),
                ...
                for k in range(0, 5120, 64):
                    with scope_4[:1, :32] as scope:
                        tile = T.tensor_view(
                            T.ptr_of(a[(t // 68) * 128:(t // 68) * 128 + 128, k:k + 64]),
    ...
    outer=Layout((32,), (1,)),
                        ...
                        tile_1 = T.tensor_view(
                            T.ptr_of(b[k:k + 64, (t % 68) * 256:(t % 68) * 256 + 256]),
    ...
    outer=Layout((32,), (1,)),
                        ...
                        window = T.tensor_view(
                            T.ptr_of(out[(t // 68) * 128:(t // 68) * 128 + 128, (t % 68) * 256:(t % 68) * 256 + 256]),
