...
def gemm(
    a: Tensor[(128, 32), "bf16"], b: Tensor[(32, 256), "bf16"], out: Tensor[(128, 256), "bf16"]
):
    with Mesh((Topology("cta", 1),), Layout((1,), (1,)), names=("d0",)) as cta:
        acc = T.alloc_tensor(
            tensor_type=Tensor[
                (128, 256),
                "f32",
                Layout((2, 4, 8, 2, 4, 2, 4, 8), (16384, 4096, 1, 8, 16, 64, 128, 512)),
                "rmem",
            ]
        )
        ...
        with Mesh(
            ...
            lhs_stages = (T.tensor_view(8192, dtype='bf16', storage=StorageKind.SMEM, layout=Layout(((2, 8, 8), (2, 8)), ((1024, 128, 8), (64, 1))), shape=(128, 16)), T.tensor_view(10240, dtype='bf16', storage=StorageKind.SMEM, layout=Layout(((2, 8, 8), (2, 8)), ((1024, 128, 8), (64, 1))), shape=(128, 16)))
            rhs_stages = (T.tensor_view(0, dtype='bf16', storage=StorageKind.SMEM, layout=Layout(((2, 8), (4, 8, 8)), ((64, 8), (1024, 128, 1))), shape=(16, 256)), T.tensor_view(4096, dtype='bf16', storage=StorageKind.SMEM, layout=Layout(((2, 8), (4, 8, 8)), ((64, 8), (1024, 128, 1))), shape=(16, 256)))
            with Mesh(
    ...
    outer=Layout((32,), (1,)),
                    ...
                    tile_1 = T.tensor_view(
                        T.ptr_of(b[k:k + 16, 0:0 + 256]),
                        layout=Layout((16, 256), (256, 1)),
                        shape=(16, 256),
                    )
                    with Mesh(
                        (Topology("thread", 384),), ComposedLayout(
                            ...
                            for o_n in range(0, 256, 64):
                                for o_k in range(0, 16, 16):
                                    acc_view = T.tensor_view(
                                        ...
                                        layout=((8 @ threads_3.d1, 2, 4 @ threads_3.d0, 2, 4 @ threads_3.d2, 8), (1, 8, 16, 64, 128, 512)),
                                        shape=(64, 64),
                                    )
                                    ...
                                    rhs_view = T.tensor_view(
                                        T.ptr_of(rhs_stages[(k // 16) % 2][o_k:o_k + 16, o_n:o_n + 64]),
                                        layout=ShardLayout(
                                            layout=Layout(((2, 8), (8, 8)), ((64, 8), (128, 1))),
                                            attrs=(B(), B(), B()),
                                            mesh=threads_3,
                                        ),
                                        shape=(16, 64),
                                    ...
                                    T.tiled_mma(
                                        ...
                                        lhs_view,
                                        rhs_view,
                                        atom=T.cuda.sm90.Wgmma(n=64, form=T.cuda.sm90.Form.SS, a_major=T.cuda.sm90.Major.K, mesh=threads_3),
                                    )
                    with Mesh(
                        (Topology("thread", 384),), ComposedLayout(
    inner=None,
                            ...
                            for o_n_1 in range(0, 256, 64):
                                for o_k_1 in range(0, 16, 16):
                                    acc_view_1 = T.tensor_view(
                                        ...
                                        layout=((8 @ threads_4.d1, 2, 4 @ threads_4.d0, 2, 4 @ threads_4.d2, 8), (1, 8, 16, 64, 128, 512)),
                                        shape=(64, 64),
                                    )
                                    lhs_view_1 = T.tensor_view(
                                        T.ptr_of(lhs_stages[(k // 16) % 2][o_m_1:o_m_1 + 64, o_k_1:o_k_1 + 16]),
                                        layout=ShardLayout(
                                            layout=Layout(((8, 8), (2, 8)), ((128, 8), (64, 1))),
                                            attrs=(B(), B(), B()),
                                            mesh=threads_4,
                                    ...
                                    rhs_view_1 = T.tensor_view(
                                        T.ptr_of(rhs_stages[(k // 16) % 2][o_k_1:o_k_1 + 16, o_n_1:o_n_1 + 64]),
                                        layout=ShardLayout(
                                            layout=Layout(((2, 8), (8, 8)), ((64, 8), (128, 1))),
                                            attrs=(B(), B(), B()),
                                            mesh=threads_4,
