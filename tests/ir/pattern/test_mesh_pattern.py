...
def test_mesh_pattern_matches_the_levels_it_names():
    with pytest.raises(ValueError, match="per_mode=True"):
        MeshPattern(
            ("thread",),
            ComposedLayoutPattern(
                outer=LayoutPattern(((128,),), ((1,),))
            ),
        )
    ...
    warpgroup = MeshPattern(
        ...
        ComposedLayoutPattern(
            ...
            outer=LayoutPattern(((128,),), ((1,),), per_mode=True),
        ),
    )
    ...
    both = MeshPattern(
        ...
        ComposedLayoutPattern(
            ...
            outer=LayoutPattern(((2,), (128,)), ((1,), (1,)), per_mode=True),
        ),
    )
