...
def insert_default_host_entry(module: Module) -> Module:
    ...
    launch_signature = LaunchSignature.from_topologies(module.effective_topologies())
    if launch_signature.grid[0] is None:
        raise ValueError(
    ...
    launch = launch_call(device_fn, entry_params)
