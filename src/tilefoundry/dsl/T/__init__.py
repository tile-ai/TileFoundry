...
def _resolve_platform(name: str):
    ...
    are resolved before the OpSchema registry
    ([parser §2.6](docs/spec/parser.md#26-platform-sub-namespaces)). Importing
    ``_platforms`` pulls in the CUDA MMA IR modules, which
