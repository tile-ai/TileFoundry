...
PAGES: tuple[str, ...] = ("index", "migrate", "run", "optimize")
...
def run_tutorial(page: str | None) -> int:
    """Print the overview and the page index, or one page."""
    import sys  # noqa: PLC0415

    sys.stdout.write(render_index() if page is None else render_page(page))
    return 0


__all__ = ["PAGES", "page_path", "render_index", "render_page", "run_tutorial"]
