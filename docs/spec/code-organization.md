...
| `analysis/performance.py` | [analysis](./analysis.md) | The `performance` family: one solve for the occurrence timeline and the addresses of the buffers it keeps live, scaled by a parallel capacity. |
