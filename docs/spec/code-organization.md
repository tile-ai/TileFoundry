...
| `analysis/check.py` | [analysis](./analysis.md) | The gate every analysis runs behind: authored-type re-derivation, authored validation, call-context validation, and checker-specific input checks. Established once per public call rather than per family. |
