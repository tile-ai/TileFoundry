...
| `analysis/performance.py` | [analysis](./analysis.md) | The `performance` family: one deterministic walk laying every occurrence on a nominal timeline, scaled by a parallel capacity. |
